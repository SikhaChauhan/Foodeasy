    ...
    <section className="flex items-center justify-center min-h-screen border">
      <div className="w-full max-w-2xl mt-4 mb-4 bg-white border-2 rounded-lg shadow-2xl shadow-black p-9">
        <div className="mb-8 text-center">
          ...
          <h2 className="mb-2 text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-red-500 drop-shadow-lg">Sign In</h2>
...
<div className="flex flex-col gap-2 mt-4 text-sm text-black-300">
  <div className="flex gap-2">
    ...
    <Link to="/sign-up" className="text-pink-500 hover:underline">
      Sign Up
    </Link>
  </div>
  <div className="flex gap-2">
    <span>Forgot your password?</span>
    <Link to="/forgotPassword" className="text-pink-500 hover:underline">
      Forgot Password
    </Link>
  </div>
</div>
